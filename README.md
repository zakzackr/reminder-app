...
# 📊 ER図
![reminder-erdのコピー](https://github.com/zakzackr/reminder-app/assets/100734822/b0cab31e-53b5-4edf-bc84-dc4bd5adaf0f)
...
# 🌈 こだわりポイント
* マルチユーザー対応    
  ⇨ ユーザーがログイン時にデータベースに保存されているユーザーIDをHTTPレスポンスのボディの中で返す   
  ⇨ そのユーザーIDをブラウザのセッションストレージに格納して、通知タスクのIDとともに以降のHTTPリクエストのURLに含める    
...
* 1分単位でリマインダーを設定できる    
  ...
  ⇨ Reminderテーブル内で、外部キーとしてユーザーIDを保持することで、通知するタスクとその受信者を結びつける
