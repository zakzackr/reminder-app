...
# 🌈 こだわりポイント
### マルチユーザー対応    
Reminderアプリでは、マルチユーザーに対応しており、ユーザーごとに個別のリマインダーを設定できるようになっています。以下のステップでユーザーのデータを管理し、リマインダーを一意に特定できる仕組みを構築しています。
...
③ユーザーがリマインダーを設定する際、セッションストレージから取得したユーザーIDをHTTPリクエストのURLに含めて送信します。これにより、各ユーザーに対応するリマインダーを正確に管理できます<br>
