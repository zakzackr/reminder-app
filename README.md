...
<br>
具体的には、ユーザーがリマインダーに対して操作を行う際、セッションストレージから取り出したユーザーIDを以下のようにHTTPリクエストのURLに含めます。これにより、ServiceやRepositoryのメソッドで特定のユーザーの特定のリマインダータスクにう対して操作を行うことが可能になります。他のユーザーとリマインダーが混在することなく、各ユーザー専用のリマインダーを設定・管理することが可能です
　
| 操作 |HTTPメソッド| URL |
| ---- | ---- |---|
